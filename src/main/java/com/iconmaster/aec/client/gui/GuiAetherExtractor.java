...
public class GuiAetherExtractor extends AetherCraftGui<TileEntityAetherExtractor> {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		this.fontRendererObj.drawStringWithShadow("AV: "+NumberUtils.display(this.te.getAether())+"/"+NumberUtils.display(te.max), 54, 58,0x00FF00);
		...
		te.calcLimit();
		this.fontRendererObj.drawStringWithShadow("Limit: "+NumberUtils.display(te.limit), 54, 20,0x00FF00);
