...
public class BlockAetherInfuser extends BlockContainer implements IAetherTransfer {
	private Icon blockIconTop, blockIconBottom;

	public BlockAetherInfuser(int id, Material material) {
		super(id, material);
		this.setHardness(1.5f);
        this.setUnlocalizedName("aec.aetherInfuser");
	...
	public void registerIcons(IconRegister iconRegister) {
		this.blockIcon = iconRegister
				.registerIcon("aec:aetherInfuserSide");
		this.blockIconTop = iconRegister
				.registerIcon("aec:aetherInfuserTop");
