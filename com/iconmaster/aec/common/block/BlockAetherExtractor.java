...
public class BlockAetherExtractor extends BlockContainer implements IAetherTransfer {
	private Icon blockIconTop, blockIconBottom;

	public BlockAetherExtractor(int id, Material material) {
		super(id, material);
		this.setHardness(1.5f);
        this.setUnlocalizedName("aec.aetherExtractor");
	...
	public void registerIcons(IconRegister iconRegister) {
		this.blockIcon = iconRegister
				.registerIcon("aec:aetherExtractorSide");
		this.blockIconTop = iconRegister
				.registerIcon("aec:aetherExtractorTop");
