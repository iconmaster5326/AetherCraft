...
public class ContainerAetherReconstructor extends Container {
	private TileEntityAetherReconstructor tileEntity;

	public ContainerAetherReconstructor(InventoryPlayer player,
			TileEntityAetherReconstructor tileEntityAetherReconstructor) {
		this.tileEntity = tileEntityAetherReconstructor;
