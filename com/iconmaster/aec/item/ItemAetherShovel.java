...
public class ItemAetherShovel extends ItemSpade {
	...
	public ItemAetherShovel(int id) {
		super(id,AetherCraft.aetherMaterial);
        this.setUnlocalizedName("aec.aetherShovel");
	...
	public void registerIcons(IconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon("aec:itemAetherShovel");
		this.activeIcon = iconRegister.registerIcon("aec:itemAetherShovelActive");
	}
