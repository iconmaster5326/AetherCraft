...
public class GuiAetherCondenser extends GuiContainer {
	private static final ResourceLocation gui_texture = new ResourceLocation(
			"aec", "textures/gui/aetherCondenserGui.png");
	private TileEntityAetherCondenser te;

	public GuiAetherCondenser(InventoryPlayer player,
			TileEntityAetherCondenser tileEntity) {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		this.drawGradientRect(9, (int) (16.0f + (a * b)), 164, 68,
